...
```
git clone https://github.com/Bhardwaj-Saurabh/rental-prices-nyc-MLPipeline.git
```
...
```bash
> mlflow run https://github.com/Bhardwaj-Saurabh/rental-prices-nyc-MLPipeline.git \
             -v 1.0.0 \
